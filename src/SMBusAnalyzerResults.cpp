...
const BitFieldDesc BatteryModeBits[] = { { 0, "INTERNAL_CHARGE_CONTROLLER" },
...
const BitFieldDesc BatteryStatusBits[] = { { 15, "OVER CHARGED ALARM" },
...
const char* ErrorCodesDesc[] = {
    "OK", "Busy", "ReservedCommand", "UnsupportedCommand", "AccessDenied", "Overflow/Underflow", "BadSize", "UnknownError",
};
